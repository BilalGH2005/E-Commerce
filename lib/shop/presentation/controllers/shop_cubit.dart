...
class ShopCubit extends Cubit<ShopState> {
  ...
  ShopCubit(ShopRepo shopRepo) : _shopRepo = shopRepo, super(ShopInitial()) {
    getShopMetadata();
  ...
  Future<void> getShopMetadata() async {
    ...
    final result = await _shopRepo.getShopMetadata();
  ...
  Future<void> getFilteredProducts({bool initialGet = false}) async {
    ...
    final result = await _shopRepo.getFilteredProducts(filters: filters);
    if (result.isData) {
